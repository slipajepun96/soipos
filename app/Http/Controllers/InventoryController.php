...
class InventoryController extends Controller
{
    ...
    public function saveGRN(Request $request): RedirectResponse
    {
        $grnData = $request->all();
        // dd($grnData);
        try{
            ...
            $stock_doc->id = StockDoc::generateCustomId("GRN", $validatedData['received_date']);
            $stock_doc->stock_doc_type = "GRN";
            $stock_doc->stock_doc_supplier_id = $validatedData['supplier_id'];
            $stock_doc->stock_doc_supplier_name = $supplier->supplier_name;
            $stock_doc->stock_doc_supplier_rob_num = $supplier->supplier_rob_num;
            ...
            $stock_doc->stock_doc_year = date('Y', strtotime($validatedData['received_date']));
            $stock_doc->stock_doc_month = date('m', strtotime($validatedData['received_date']));
            $stock_doc->stock_doc_date = $validatedData['received_date'];
            ...
            return Redirect::route('inventory.stockIn.addGRN')->with([
                'type' => 'success',
            ...
            return redirect()->back()
                ->with('error', 'Failed to save inventory')
